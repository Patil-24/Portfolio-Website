...
function Home() {
  ...
  const social = [
    {
      link: 'https://www.linkedin.com/in/iranna-patil/',
      icon: <FaLinkedinIn/>,
    },
    {
      link: 'https://github.com/Patil-24',
      icon: <AiFillGithub/>,
    },
    {
      link: 'https://twitter.com/iranna_patil24',
      icon: <FaXTwitter/>,
    },
    {
      link: 'https://www.instagram.com/iranna_patil24/',
      icon: <FaInstagram/>,
    }
  ]
  ...
  return (
    <div id='Home' className=' bg-white text-black dark:bg-slate-900 dark:text-white lg:px-56 lg:py-0 px-10 py-20 text-center gap-5 lg:text-start flex lg:flex-row flex-col-reverse justify-between lg:gap-28 items-center'>
      <div className='h-full lg:py-40 flex flex-col justify-center lg:items-start items-center '>
        ...
        <p data-aos='fade-left'>"Welcome to my digital space! I'm Iranna Patil, a passionate React Native Developer dedicated to crafting engaging mobile experiences. With a penchant for innovation and a commitment to excellence, I thrive in turning ideas into reality. Explore my journey below."</p>
